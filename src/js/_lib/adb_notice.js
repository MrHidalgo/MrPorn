class AdBlockDetector {
	...
	createNotice() {
		...
		el.innerHTML = "<span>Ad blocker detected! Some features and links may not load or function correctly while it's enabled. Switch it off for the best experience.</span><button class=\"adblock-notice-close\"><svg class=\"icon\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0.51 0.51 22.99 22.99\" width=\"16px\" height=\"16px\" fill=\"#ffffff\">\n" +
