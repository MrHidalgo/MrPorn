/**
 * Global variables and utilities that need to be available to all modules
 */
...
let isMobileOrTablet = window.mobileAndTabletcheck();

// Make isMobileOrTablet globally available for other modules
...
// Make storage utilities globally available
...
window.doScrolling = doScrolling;
