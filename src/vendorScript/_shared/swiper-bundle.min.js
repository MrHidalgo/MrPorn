...
!function (e, t) {
	...
	const c = {
		addClass: function (...e) {
			...
			if (1 === arguments.length) {
				...
				if (this[0]){
					let styleProp = '';
					if(stylePropData[e] === undefined){
						 styleProp = s.getComputedStyle(this[0], null).getPropertyValue(e)
						stylePropData[e] = styleProp;
					}else{
						styleProp = stylePropData[e];
					}
					return styleProp;
				}
			}
	...
	function E(e = {}) {
		return b || (b = function ({userAgent: e} = {}) {
			const t = y(), s = r(), a = s.navigator.platform, i = e || s.navigator.userAgent, n = {ios: !1, android: !1},
