    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        liChar.addEventListener("click", function (e) {
          ...
          (_document$querySelect10 = document.querySelector('.category-list-letter.active')) === null || _document$querySelect10 === void 0 ? void 0 : _document$querySelect10.classList.remove('active');
...
var ReportModal = /*#__PURE__*/function () {
  ...
  _createClass(ReportModal, [{
    ...
    value: function generateTypeFilterPopupContent() {
      ...
      var filterOptions = (_document$querySelect14 = document.querySelector('.review_type_slider')) === null || _document$querySelect14 === void 0 ? void 0 : _document$querySelect14.innerHTML;
    ...
    value: function onOptionClicked(target) {
      var _this$parentContainer, _document$querySelect15, _document$querySelect16;
      ...
      (_document$querySelect15 = document.querySelector('.review_type_container .option.active')) === null || _document$querySelect15 === void 0 ? void 0 : _document$querySelect15.classList.remove('active');
      (_document$querySelect16 = document.querySelector('.review_type_container .option.' + siteType)) === null || _document$querySelect16 === void 0 ? void 0 : _document$querySelect16.classList.add('active');
    ...
    value: function initPopupEvents() {
      var _document$querySelect17, _document$querySelect18, _document$querySelect19;

      var parent = this;
      (_document$querySelect17 = document.querySelector('.boogie-list-item.problem')) === null || _document$querySelect17 === void 0 ? void 0 : _document$querySelect17.addEventListener('click', function (evt) {
      ...
      (_document$querySelect18 = document.querySelector('.boogie-list-item.recommendations')) === null || _document$querySelect18 === void 0 ? void 0 : _document$querySelect18.addEventListener('click', function (evt) {
        evt.preventDefault(); // MicroModal.close('type-filter-modal');

        parent.injectReportReviewModal('recommendations', 'Website Recommendations for'); // parent.showReportForm('recommendations')
      });
      (_document$querySelect19 = document.querySelector('.boogie-list-item.feedback')) === null || _document$querySelect19 === void 0 ? void 0 : _document$querySelect19.addEventListener('click', function (evt) {
        evt.preventDefault(); // MicroModal.close('type-filter-modal');
