...
var A2ZPopup = /*#__PURE__*/function () {
  function A2ZPopup(data) {
    ...
    var parent = this;
    (_document$querySelect = document.querySelector('.sort__toggle')) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener('click', function () {
      var _document$querySelect2;
      // document.querySelector('.search__close')?.click()
      (_document$querySelect2 = document.querySelector('[search-mobile-js]')) === null || _document$querySelect2 === void 0 || _document$querySelect2.classList.remove("is-open");
      parent.showA2ZPopup();
    });
  ...
  return _createClass(A2ZPopup, [{
    ...
    value: function showA2ZPopup() {
      ...
      if (isMobileOrTablet) {
        ...
        a2zModal === null || a2zModal === void 0 || a2zModal.classList.add('is-open');
        ...
        (_document$querySelect3 = document.querySelector('#a2z-modal .micromodal-close')) === null || _document$querySelect3 === void 0 || _document$querySelect3.addEventListener('click', function (evt) {
        ...
        MicroModal.show('a2z-modal', {
          onShow: function onShow() {
            ...
            filterInput === null || filterInput === void 0 || filterInput.setAttribute('tabindex', '-1');
            filterInput === null || filterInput === void 0 || filterInput.blur();
          },
    ...
    value: function addA2ZPopupListeners() {
      ...
      var parent = this;
      (_document$querySelect4 = document.querySelector('#filter_tag_input')) === null || _document$querySelect4 === void 0 || _document$querySelect4.addEventListener('input', debounce(function (evt) {
      ...
      document.querySelectorAll('.a2z-letter-item').forEach(function (letter) {
        letter.addEventListener('click', function (evt) {
          ...
          (_document$querySelect5 = document.querySelector('.a2z-letter-item.active')) === null || _document$querySelect5 === void 0 || _document$querySelect5.classList.remove('active');
      ...
      document.querySelector('.a2z-reset').addEventListener('click', function () {
        ...
        (_document$querySelect6 = document.querySelector('.a2z-letter-item.active')) === null || _document$querySelect6 === void 0 || _document$querySelect6.classList.remove('active');
        (_document$querySelect7 = document.querySelector('.a2z-letter-item.all')) === null || _document$querySelect7 === void 0 || _document$querySelect7.classList.add('active');
    ...
    value: function initCategoryEvents() {
      ...
      document.querySelectorAll('.a2z-category-item').forEach(function (category) {
        category.addEventListener('click', function (evt) {
          ...
          (_document$querySelect8 = document.querySelector('.a2z-category-item.active')) === null || _document$querySelect8 === void 0 || _document$querySelect8.classList.remove('active');
          var cat = evt.target;
...
function initCategoryPage() {
  ...
  var sidebarAllTags = document.querySelectorAll('.sidebar-all-tags');
  ...
  var initTagsContainerSlide = function initTagsContainerSlide() {
  ...
  if (allTagsCookie == '1') {
    ...
    if (sidebarAllTags.length > 0) {
      sidebarAllTags.forEach(function (element) {
        element.classList.add('show');
      });
      categoryListContainer === null || categoryListContainer === void 0 || categoryListContainer.classList.add('show_tags');
  ...
  function createSidebar() {
    ...
    if (categoryFilter.length > 0) {
      for (var i = 0; i < categoryFilter.length; i++) {
        categoryFilter[i].addEventListener('input', debounce(function (evt) {
          ...
          var catCount = filteredCategories.length;
          ...
          desktopMenuListContainer === null || desktopMenuListContainer === void 0 || desktopMenuListContainer.scrollTo({
            top: 0,
            behavior: "smooth"
          });
          mobileMenuList === null || mobileMenuList === void 0 || mobileMenuList.scrollTo({
            top: 0,
            behavior: "smooth"
          });
        }));
    ...
    var timeoutId;
    if (!isMobile) {
      categoryFilterBtn === null || categoryFilterBtn === void 0 || categoryFilterBtn.addEventListener('mouseover', function () {
        clearTimeout(timeoutId);
        if (!categoryFilterOptions.classList.contains('open')) {
          categoryFilterOptions.classList.add('open');
        }
      });
      categoryFilterBtn === null || categoryFilterBtn === void 0 || categoryFilterBtn.addEventListener('mouseout', function () {
        timeoutId = setTimeout(function () {
          categoryFilterOptions.classList.remove('open');
        }, 700); // 2000 milliseconds = 2 seconds
      });
    }
    categoryFilterBtn === null || categoryFilterBtn === void 0 || categoryFilterBtn.addEventListener('click', function () {
    ...
    if (!initializedListeners) {
      ...
      filterOptionScroll === null || filterOptionScroll === void 0 || filterOptionScroll.addEventListener('change', function () {
        onScrollChecked(this.checked);
      }, false);
      filterOptionA2Z === null || filterOptionA2Z === void 0 || filterOptionA2Z.addEventListener('change', function () {
        onA2ZChecked(!this.checked);
      }, false);
      filterOptionRandom === null || filterOptionRandom === void 0 || filterOptionRandom.addEventListener('change', function () {
        gotoRandomCategory();
      });
      filterOptionTags === null || filterOptionTags === void 0 || filterOptionTags.addEventListener('change', function () {
        if (this.checked) {
      ...
      (_document$querySelect9 = document.querySelector('.category-list-switcher')) === null || _document$querySelect9 === void 0 || _document$querySelect9.addEventListener('click', function () {
        onA2ZChecked(frontListA2Z);
        frontListA2Z = !frontListA2Z;
        if (frontListA2Z) {
          frontMainFilter === null || frontMainFilter === void 0 || frontMainFilter.classList.remove('a2z');
        } else {
          frontMainFilter === null || frontMainFilter === void 0 || frontMainFilter.classList.add('a2z');
        }
        initStickySidebar();
      });
  ...
  var onScrollChecked = function onScrollChecked(checked) {
    ...
    if (checked) {
      ...
      leftSidebar === null || leftSidebar === void 0 || leftSidebar.classList.add('scroll');
      catListSites === null || catListSites === void 0 || catListSites.classList.remove('has_sidebar');
      catListSites === null || catListSites === void 0 || catListSites.classList.add('scroll');
      if (categorySidebar) {
      ...
      var _document$querySelect0;
      createCookie("category_filter_scroll", 0, 356);
      leftSidebar === null || leftSidebar === void 0 || leftSidebar.classList.remove('scroll');
      (_document$querySelect0 = document.querySelector('.category_list-sites')) === null || _document$querySelect0 === void 0 || _document$querySelect0.classList.add('has_sidebar');
      catListSites === null || catListSites === void 0 || catListSites.classList.remove('scroll');
  ...
  var setSidebarHeight = function setSidebarHeight() {
    ...
    if (reset) {
      categoryListContainer === null || categoryListContainer === void 0 || categoryListContainer.style.removeProperty('height');
    } else {
  ...
  var renderA2ZLetters = function renderA2ZLetters() {
    ...
    for (var _i = 0, _a2zLetters = a2zLetters; _i < _a2zLetters.length; _i++) {
      var letter = _a2zLetters[_i];
      ...
      liChar.addEventListener("click", function (e) {
        var _document$querySelect1;
        var triggeredLetter = e.currentTarget.dataset.letter;
        (_document$querySelect1 = document.querySelector('.category-list-letter.active')) === null || _document$querySelect1 === void 0 || _document$querySelect1.classList.remove('active');
  ...
  var initLetterScroll = function initLetterScroll() {
    ...
    letterLinks.forEach(function (letterLink) {
      letterLink.addEventListener('click', function (e) {
        ...
        (_container$querySelec = container.querySelector('.category-list-letter.active')) === null || _container$querySelec === void 0 || _container$querySelec.classList.remove('active');
  ...
  var renderCategorySidebar = function renderCategorySidebar(categoryItems) {
    ...
    if (filterA2z) {
      categoryListContainer === null || categoryListContainer === void 0 || categoryListContainer.classList.add('a2z');
      renderA2ZLetters();
    } else {
      categoryListContainer === null || categoryListContainer === void 0 || categoryListContainer.classList.remove('a2z');
    }
    ...
    categoryItems.map(function (categoryItem) {
      ...
      desktopMenuList === null || desktopMenuList === void 0 || desktopMenuList.insertAdjacentHTML('beforeend', item);
      mobileMenuList === null || mobileMenuList === void 0 || mobileMenuList.insertAdjacentHTML('beforeend', item);
    ...
    reorderCategories();
    if (filterA2z) {
      for (var _i2 = 0, _a2zLetters2 = a2zLetters; _i2 < _a2zLetters2.length; _i2++) {
        var _desktopMenuListConta;
        var letter = _a2zLetters2[_i2];
        var letterTop = desktopMenuListContainer === null || desktopMenuListContainer === void 0 || (_desktopMenuListConta = desktopMenuListContainer.querySelector('.category-list-item-letter.letter_' + letter)) === null || _desktopMenuListConta === void 0 ? void 0 : _desktopMenuListConta.offsetTop;
        letterOffsets[letter] = letterTop;
      }
      desktopMenuListContainer === null || desktopMenuListContainer === void 0 || desktopMenuListContainer.addEventListener("scroll", function () {
  ...
  var processHomeCategories = function processHomeCategories(result) {
    var _result$terms;
    sidebarCategories = [];
    (_result$terms = result.terms) === null || _result$terms === void 0 || _result$terms.forEach(function (term) {
      var icons = '';
      var siteIndex = 0;
  ...
  var processA2ZData = function processA2ZData(result) {
    ...
    for (var letter in result.categories) {
      ...
      var _iterator = _createForOfIteratorHelper(result.categories[letter]),
        _step;
      try {
...
var ReportModal = /*#__PURE__*/function () {
  ...
  return _createClass(ReportModal, [{
    ...
    value: function submitForm() {
      ...
      var accepted = document.querySelector('#boogie-checkbox-input').checked;
    ...
    value: function generateTypeFilterPopupContent() {
      ...
      var filterOptions = (_document$querySelect13 = document.querySelector('.review_type_slider')) === null || _document$querySelect13 === void 0 ? void 0 : _document$querySelect13.innerHTML;
    ...
    value: function onOptionClicked(target) {
      var _this$parentContainer, _document$querySelect14, _document$querySelect15;
      ...
      (_this$parentContainer = this.parentContainer.querySelector('.review_type_slider .option.active')) === null || _this$parentContainer === void 0 || _this$parentContainer.classList.remove('active');
      this.slideToType(target);
      (_document$querySelect14 = document.querySelector('.review_type_container .option.active')) === null || _document$querySelect14 === void 0 || _document$querySelect14.classList.remove('active');
      (_document$querySelect15 = document.querySelector('.review_type_container .option.' + siteType)) === null || _document$querySelect15 === void 0 || _document$querySelect15.classList.add('active');
    ...
    value: function checkAvailability() {
      ...
      (_this$parentContainer2 = this.parentContainer) === null || _this$parentContainer2 === void 0 || _this$parentContainer2.querySelectorAll('.review_type_slider .option').forEach(function (option) {
    ...
    value: function initPopupEvents() {
      ...
      var parent = this;
      (_document$querySelect16 = document.querySelector('.boogie-list-item.problem')) === null || _document$querySelect16 === void 0 || _document$querySelect16.addEventListener('click', function (evt) {
        evt.preventDefault();
      ...
      (_document$querySelect17 = document.querySelector('.boogie-list-item.recommendations')) === null || _document$querySelect17 === void 0 || _document$querySelect17.addEventListener('click', function (evt) {
        evt.preventDefault();
        // MicroModal.close('type-filter-modal');
        parent.injectReportReviewModal('recommendations', 'Website Recommendations for');
        // parent.showReportForm('recommendations')
      });
      (_document$querySelect18 = document.querySelector('.boogie-list-item.feedback')) === null || _document$querySelect18 === void 0 || _document$querySelect18.addEventListener('click', function (evt) {
        evt.preventDefault();
        // MicroModal.close('type-filter-modal');
...
var StickySidebar = function () {
  ...
  var StickySidebar = /*#__PURE__*/function () {
    ...
    function StickySidebar(sidebar, mainContainer) {
      ...
      var sidebarElement = 'string' === typeof sidebar ? document.querySelector(sidebar) : sidebar;
      var mainElement = 'string' === typeof mainContainer ? document.querySelector(mainContainer) : mainContainer;

      // Sidebar element query if there's no one, throw error.
      // this.sidebar = ('string' === typeof sidebar ) ? document.querySelector(sidebar) : sidebar;
      if (sidebarElement.scrollHeight > mainElement.scrollHeight) {
        this.sidebar = mainElement;
      } else {
...
var TagsShrinkEffect = /*#__PURE__*/function () {
  function TagsShrinkEffect(tagsContainerId, sidebarId) {
    _classCallCheck(this, TagsShrinkEffect);
  ...
  return _createClass(TagsShrinkEffect, [{
    key: "_initialize",
    value: function _initialize() {
      ...
      this.tagsContainer.style.height = "".concat(this.initialTagsHeight, "px");
    ...
    key: "_captureInitialHeight",
    value: function _captureInitialHeight() {
      // Temporarily set height to 'auto' to measure its natural content height
      var originalHeightStyle = this.tagsContainer.scrollHeight;
    ...
    value: function _updateOnScroll() {
      ...
      // Apply styles
      var currentTagsHeight = this.initialTagsHeight - (this.initialTagsHeight - this.MIN_TAGS_HEIGHT) * progress;
      this.tagsContainer.style.height = "".concat(currentTagsHeight, "px");
      var currentTagOpacity = this.INITIAL_TAG_OPACITY - (this.INITIAL_TAG_OPACITY - this.MIN_TAG_OPACITY) * progress;
      this.tagsToFade.forEach(function (tagEl) {
...
function detectCountryAndVerifyAge() {
  ...
  fetch('/api/country.php').then(function (response) {
    return response.json();
  }).then(function (data) {
...
function showAgeVerification(country) {
  ...
  if (!isVerified) {
    if (country == 'DE') {
      ...
      var avHtml = '<div class="modal_age">' + '<div class="modal_inner">' + '<img src="/wp-content/themes/mpg/images/logo-mob.png"/>' + '<div class="title">Altersüberprüfung</div>' + '<p>MrPornGeek ist eine Erwachsenen-Community, die altersbeschränkte Inhalte enthält.<br/>' + 'Du musst 18 Jahre oder älter sein, um teilnehmen zu können.</p>' + '<button class="btn btnPrimary greyButton js-closeAgeModal">Ich bin 18 oder älter - Eingabe</button>' + '</div>' + '</div>';
      document.body.insertAdjacentHTML('beforeend', avHtml);
    } else if (country == 'GB' || country == 'LK') {
      console.log('English pop');
      var _avHtml = '<div class="modal_age">' + '<div class="modal_inner">' + '<img src="/wp-content/themes/mpg/images/logo-mob.png"/>' + '<div class="title">ADULTS ONLY 18+</div>' + '<p class="modal_age_p">You\'re accessing this site from the United Kingdom.<br/>' + 'This website is intended for adults aged 18 or over only.<br/>' + 'By continuing, you confirm that you are 18+ years of age or older</p>' + '<div class="modal_age_buttons flex flex-hc">' + '<button class="btn btn_in btnPrimary greyButton js-closeAgeModal">I’m Over 18+ – Let Me In</button>' + '<a href="https://www.google.com/" class="btn btn_exit btnPrimary greyButton">I’m Under 18 – Exit</a>' + '</div>';
      '</div>' + '</div>';
      document.body.insertAdjacentHTML('beforeend', _avHtml);
    }
  } else {
