...
function detectCountryAndVerifyAge() {
  var apiUrl = 'https://ip-api.com/json/';
  fetch(apiUrl).then(function (response) {
    ...
    if (data.countryCode === 'DE') {
      ...
      console.log('User is from the UK'); // showUKSpecificContent(); // Example function for UK visitors
    } else {
      console.log("User is from ".concat(data.country));
    }
  })["catch"](function (error) {
